...
#XML(eXtensible Markup Language) - Marking up language to send across the network 


#JSON represents data as nested "lists" and "dictionaries"

#Service Oriented Approach - is a way we approach solving a complex application problem where the data that lives over one computer system is spread out over the internet connected via internet or internal network
